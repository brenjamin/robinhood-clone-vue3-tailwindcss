<template>
  <div class="md:flex leading-lax min-h-screen">
    <div class="md:w-3/5 left md:pb-8">
      <div
        class="pt-4 pb-14 px-8 md:p-0 md:mx-auto md:max-w-3xl md:pt-10 mb:pb-12"
      >
        ...
        <form @submit.prevent="handleSubmit" class="text-base-xs mt-10">
          <input
            ...
            type="email"
            disabled
            placeholder="Email – input disabled, for demo use"
            class="block w-full px-3 py-1.5 bg-light-gray rounded border border-solid border-light-gray hover:bg-white transition-colors duration-200 focus:outline-none focus:border-green focus:bg-white"
          />
          <input
            v-model="password"
            type="password"
            placeholder="Password – input disabled, for demo use"
            class="block w-full mt-6 px-3 py-1.5 bg-light-gray rounded border border-solid border-light-gray hover:bg-white transition-colors duration-200 focus:outline-none focus:border-green focus:bg-white"
            disabled
          />
          <button
            v-if="!isPending"
            type="submit"
            class="button-login mt-12 min-w-36 disabled:opacity-50"
            disabled
          >
            Continue
          </button>
        ...
        <router-link
          ...
          class="block text-green font-medium text-base-xs mt-8"
          >Already have an account? View sample dashboard.</router-link
        >
        <div class="hidden md:block text-fine-print leading-relaxed mt-25">
          ...
          <p class="mt-4">
            ...
            account. Please see Robinhood Financial’s
            <a href class="text-green text-inherit font-medium">fee schedule</a>
            to learn more.
          </p>
          <p class="mt-4">
            Securities trading offered through Robinhood Financial LLC.
            Brokerage clearing services offered through Robinhood Securities,
            LLC. Both are subsidiaries of Robinhood Markets, Inc.
          </p>
          <p class="mt-4">
            <a href class="text-green text-inherit font-medium"
              >Check the background of Robinhood Financial LLC and Robinhood
              Securities, LLC on FINRA’s BrokerCheck.</a
            >
          </p>
          <p class="mt-4 text-green font-medium">
    ...
    <div
      class="right bg-light-gray md:w-2/5 p-8 pb-12 md:pb-0 md:pt-44 text-base-sm"
    >
      ...
      <div class="md:hidden text-fine-print leading-relaxed mt-20">
        ...
        <p class="mt-4">
          ...
          Please see Robinhood Financial’s
          <a href class="text-green text-inherit font-medium">fee schedule</a>
          to learn more.
        </p>
        <p class="mt-4">
          Securities trading offered through Robinhood Financial LLC. Brokerage
          clearing services offered through Robinhood Securities, LLC. Both are
          subsidiaries of Robinhood Markets, Inc.
        </p>
        <p class="mt-4">
          <a href class="text-green text-inherit font-medium"
            >Check the background of Robinhood Financial LLC and Robinhood
  ...
  setup() {
    ...
    const features = [
      ...
      },
      {
        ...
        description:
          'Robinhood Financial is a member of SIPC. Securities in your account protected up to $500,000. For details, please see <a class="text-green text-base-sm">www.sipc.org</a>.'
      },
      {
