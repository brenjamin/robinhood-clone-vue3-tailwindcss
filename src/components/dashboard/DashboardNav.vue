<template>
  <div class="z-50 fixed inset-x-0" ref="fixedNavWrapper">
    <div
    ...
    >
          ...
          >
            <div class="flex items-center">
              <div
                ...
                :class="
                  searchIsFocused
                    ...
                    : 'text-text-gray dark:text-text-gray-light'
                "
              >
                <svg
                  role="img"
              ...
              <input
                ...
                @blur="blurInput"
                class="flex-grow h-8.5 focus:outline-none bg-inherit"
              />
            </div>
            <div class="py-4" v-show="searchIsFocused && resultsReturned">
              <div v-if="searchResults.length">
                <div
                  ...
                  :key="index"
                  class="hover:bg-border-gray dark:hover:bg-neutral-bg-3 mt-1.5 first:mt-0 -mx-3"
                >
                  <router-link
                    :to="{
                      name: 'SingleStock',
      ...
      <div class="text-base-xs flex items-center gap-x-8 font-bold">
        ...
        <button
          ...
          class="hover:text-green dark:hover:text-red font-bold"
        >
          Dark Mode
        </button>
        <button
  ...
  <div :style="{ height: spacerHeight + 'px' }" ref="fixedNavSpacer"></div>
</template>
            ...
            if (results.length) {
              ...
              searchResults.value = searchResults.value.map(item => {
                item.symbol = item.symbol.replace(
                  matchThis,
                  '<span class="text-green dark:text-red">$&</span>'
                )
